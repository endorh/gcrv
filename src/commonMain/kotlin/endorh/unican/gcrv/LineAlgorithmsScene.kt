...
class LineAlgorithmsScene : DemoScene("Line Algorithms") {
    ...
    val dock = Dock()
    val demoWindows = mutableListOf<BaseWindow>()
    ...
    override fun Scene.setupMainScene(ctx: KoolContext) {
        ...
        spawnWindow(LauncherWindow(this@LineAlgorithmsScene), "0:row/0:leaf")
        spawnWindow(PixelCanvasRendererWindow(this@LineAlgorithmsScene), "0:row/1:leaf")

        // TextStyleWindow is spawned as a floating window
        // spawnWindow(TextStyleWindow(this@LineAlgorithmsScene))
