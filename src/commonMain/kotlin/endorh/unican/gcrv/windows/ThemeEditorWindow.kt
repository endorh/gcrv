...
class ThemeEditorWindow(scene: LineAlgorithmsScene) : BaseWindow("Theme Editor", scene) {
    ...
    private val colorEntries = listOf(
        ColorEntry("Primary", scene.selectedColors.value.primary),
        ColorEntry("Primary variant", scene.selectedColors.value.primaryVariant),
        ColorEntry("Secondary", scene.selectedColors.value.secondary),
        ColorEntry("Secondary variant", scene.selectedColors.value.secondaryVariant),
        ColorEntry("Background", scene.selectedColors.value.background),
        ColorEntry("Background variant", scene.selectedColors.value.backgroundVariant),
        ColorEntry("On primary", scene.selectedColors.value.onPrimary),
        ColorEntry("On secondary", scene.selectedColors.value.onSecondary),
        ColorEntry("On background", scene.selectedColors.value.onBackground)
    )
    ...
    override fun UiScope.windowContent() = Column(Grow.Std, Grow.Std) {
        scene.selectedColors.set(makeColors())
        ...
        Column(Grow.Std, Grow.Std) {
            ...
            Row {
                ...
                RadioButton(scene.selectedUiSize.use() == Sizes.small) {
                    modifier
                        .margin(start = sizes.largeGap, end = sizes.gap)
                        .alignY(AlignmentY.Center)
                        .onClick {scene.selectedUiSize.set(Sizes.small) }
                }
                Text("Small") {
                    modifier
                        .alignY(AlignmentY.Center)
                ...
                RadioButton(scene.selectedUiSize.use() == Sizes.medium) {
                    modifier
                        .margin(start = sizes.largeGap, end = sizes.gap)
                        .alignY(AlignmentY.Center)
                        .onClick {scene.selectedUiSize.set(Sizes.medium) }
                }
                Text("Medium") {
                    modifier
                        .alignY(AlignmentY.Center)
                ...
                RadioButton(scene.selectedUiSize.use() == Sizes.large) {
                    modifier
                        .margin(start = sizes.largeGap, end = sizes.gap)
                        .alignY(AlignmentY.Center)
                        .onClick {scene.selectedUiSize.set(Sizes.large) }
                }
                Text("Large") {
                    modifier
                        .alignY(AlignmentY.Center)
