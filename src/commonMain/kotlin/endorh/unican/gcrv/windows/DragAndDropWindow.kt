...
sealed class DragAndDropWindow(name: String, scene: LineAlgorithmsScene) : BaseWindow(name, scene) {
    ...
    override fun onClose() {
        super.onClose()
        scene.dndContext.removeHandler(dndHandler)
    }
        ...
        ScrollArea(containerModifier = {
            it
                ...
                .onPositioned { nd ->
                    ...
                    scene.dndContext.registerHandler(dndHandler)
    ...
    private fun UiScope.DndItem(item: DndItem, itemW: Dimension, itemH: Dimension, margin: Dp) {
        Box {
            ...
            modifier
                ...
                .installDragAndDropHandler(scene.dndContext, dndHandler) { item }
    ...
    class A(scene: LineAlgorithmsScene) : DragAndDropWindow("Drag and Drop A", scene)
    class B(scene: LineAlgorithmsScene) : DragAndDropWindow("Drag and Drop B", scene)
